      ...
      <div class="col-lg-4">
        <div class="category">
          ...
          <ul class="list-group">
            ...
            <li class="list-group-item {{$c->id == $id ? 'active' : ''}}"> <a href="/shop/categories/{{$c->id}}">{{$c->name}}</a></li>
            @endforeach
          </ul>
        </div>
        ...
        <div class="col-lg-8">
          ...
          <div class="row list-product">
            ...
            <div class="col-lg-4 item mb-5">
              ...
              <img src="{{asset($p->image)}}" alt="nopic" height="180" width="180">
              </a>
              <p class="product-name mt-3 font-weight-bold"><a href="">{{$p->name}}</a></p>
              <p class="product-price">{{number_format($p->price)}}</p>
            </div>
            @endforeach
          </div>
        </div>
